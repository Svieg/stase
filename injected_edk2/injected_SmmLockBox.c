...
#include "../edk2/MdePkg/Include/PiSmm.h"
#include "../edk2/MdePkg/Include/Library/UefiDriverEntryPoint.h"
#include "../edk2/MdePkg/Include/Library/UefiBootServicesTableLib.h"
#include "../edk2/MdePkg/Include/Library/UefiRuntimeServicesTableLib.h"
#include "../edk2/MdePkg/Include/Library/SmmServicesTableLib.h"
#include "../edk2/MdePkg/Include/Library/BaseLib.h"
#include "../edk2/MdePkg/Include/Library/BaseMemoryLib.h"
#include "../edk2/MdePkg/Include/Library/DebugLib.h"
#include "../edk2/MdePkg/Include/Library/SmmMemLib.h"
#include "../edk2/MdeModulePkg/Include/Library/LockBoxLib.h"

#include "../edk2/MdePkg/Include/Protocol/SmmReadyToLock.h"
#include "../edk2/MdePkg/Include/Protocol/SmmCommunication.h"
#include "../edk2/MdeModulePkg/Include/Protocol/LockBox.h"
#include "../edk2/MdeModulePkg/Include/Guid/SmmLockBox.h"
  ...
  )
{
  ...
  CopyMemStub (&TempLockBoxParameterSave, LockBoxParameterSave, sizeof (EFI_SMM_LOCK_BOX_PARAMETER_SAVE));
  ...
  )
{
  ...
  CopyMemStub (&TempLockBoxParameterSetAttributes, LockBoxParameterSetAttributes, sizeof (EFI_SMM_LOCK_BOX_PARAMETER_SET_ATTRIBUTES));
  ...
  )
{
  ...
  klee_assert(((UINTN)*CommBufferSize <= (SMRAM_BASE + SMRAM_SIZE)) &&
            ((UINTN)LockBoxParameterUpdate <= (SMRAM_BASE + SMRAM_SIZE)) &&
            (((UINTN)*CommBufferSize  == 0) || ((UINTN)LockBoxParameterUpdate <= ((SMRAM_BASE + SMRAM_SIZE) - *CommBufferSize ))));
  CopyMemStub (&TempLockBoxParameterUpdate, LockBoxParameterUpdate, sizeof (EFI_SMM_LOCK_BOX_PARAMETER_UPDATE));
  ...
  )
{
  ...
  CopyMemStub (&TempLockBoxParameterRestore, LockBoxParameterRestore, sizeof (EFI_SMM_LOCK_BOX_PARAMETER_RESTORE));
  ...
  )
{
  ...
  if (!SmmIsBufferOutsideSmmValid ((UINTN)CommBuffer, TempCommBufferSize)) {
   ...
   LockBoxParameterHeader = (EFI_SMM_LOCK_BOX_PARAMETER_HEADER *)(CommBuffer);
   LockBoxParameterHeader->ReturnStatus = (UINT64)-1;//Target
