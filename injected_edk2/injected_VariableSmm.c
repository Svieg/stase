  ...
  )
{
  ...
  switch (SmmVariableFunctionHeader->Function) {
    case SMM_VARIABLE_FUNCTION_GET_VARIABLE:
      ...
      klee_assert(CommBufferSize <= CommBufferPayloadSize);           
    ...
    case SMM_VARIABLE_FUNCTION_GET_STATISTICS:
      ...
      *CommBufferSize = InfoSize + SMM_VARIABLE_COMMUNICATE_HEADER_SIZE;
      //klee_assert(  *CommBufferSize >= SMM_VARIABLE_COMMUNICATE_HEADER_SIZE);
      break;
    ...
    case SMM_VARIABLE_FUNCTION_VAR_CHECK_VARIABLE_PROPERTY_GET:
      ...
      //klee_assert(CommBufferPayloadSize <= CommBufferSize);
      CopyMem (SmmVariableFunctionHeader->Data, mVariableBufferPayload, CommBufferPayloadSize);
      break;
